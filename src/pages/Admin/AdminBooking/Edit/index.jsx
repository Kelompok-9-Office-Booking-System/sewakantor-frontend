...
const AdminEditBooking = () => {
  ...
  return (
    <div className={`bg-skSmoke position-relative`} style={{ height: "100%" }}>
      <AdminSidebar />
      <AdminContentContainer title={"Edit Schedule Booking"} breadcrumb={true}>
        <AdminDataContainer title={"Edit Schedule Bookings"}>
          <form className={style.form_input_address} onSubmit={handleSubmit}>
            ...
            <div className="row mt-4">
              ...
              <div className="col-6">
                ...
                />
                <br />
                <span className="text-danger">{errorMessage.noHandphone}</span>
              </div>
            </div>
            <div className="row mt-4">
              <div className="col-6">
